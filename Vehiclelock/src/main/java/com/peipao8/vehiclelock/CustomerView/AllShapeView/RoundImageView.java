package com.peipao8.vehiclelock.CustomerView.AllShapeView;
...
public class RoundImageView extends ImageView {
     ...
     * @param borderOutsideColor 边框颜色
     * @return
     */
    public Bitmap DrawBitmap(Canvas canvas, int borderThickness, int borderOutsideColor){
        ...
        int radius = 0;
        if (borderOutsideColor != defaultColor) {// 定义画一个边框
